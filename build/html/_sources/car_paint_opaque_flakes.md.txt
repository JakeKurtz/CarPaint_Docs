...
<img src="../images/c_opaque_flakes.png" alt="my alt text" width="50%"/>
...
<figure>
  <img src="../images/flake_opaque_scale/strip.png" alt="my alt text"/>
...
<figure>
  <img src="../images/flake_opaque_density/strip.png" alt="my alt text"/>
...
<figure>
  <img src="../images/flake_opaque_var/strip.png" alt="my alt text"/>
...
<figure>
  <img src="../images/flake_opaque_roughness/strip.png" alt="my alt text"/>
  <figcaption text-align="center">Roughness from 0.0 to 1.0</figcaption>
</figure>
...
<figure>
  <img src="../images/flake_opaque_absorption/strip.png" alt="my alt text"/>
...
<figure>
  <img src="../images/flake_opaque_weight/strip.png" alt="my alt text"/>
...
<div class="video_container">
    <figure>
        <video width="100%" height="auto" controls loop>
            <source src="../images/flake_opaque_ior/vid.mp4" type="video/mp4">
        </video>
        <figcaption text-align="center">Film IOR from 1.0 to 3.0</figcaption>
    </figure>
    <figure>
        <video width="100%" height="auto" controls loop>
            <source src="../images/flake_opaque_thickness/vid.mp4" type="video/mp4">
        </video>

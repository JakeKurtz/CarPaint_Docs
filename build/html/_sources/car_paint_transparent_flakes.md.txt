...
<img src="../images/c_trans_flakes.png" alt="my alt text" width="50%"/>
...
<figure>
  <img src="../images/bc_spec_tint/strip.png" alt="my alt text"/>
...
<figure>
  <img src="../images/flake_trans_scale/strip.png" alt="my alt text"/>
...
<figure>
  <img src="../images/flake_trans_density/strip.png" alt="my alt text"/>
...
<figure>
  <img src="../images/flake_trans_var/strip.png" alt="my alt text"/>
...
<figure>
  <img src="../images/flake_trans_roughness/strip.png" alt="my alt text"/>
  <figcaption text-align="center">Roughness from 0.0 to 1.0</figcaption>
</figure>
...
<figure>
  <img src="../images/flake_trans_absorption/strip.png" alt="my alt text"/>
...
<figure>
  <img src="../images/flake_trans_weight/strip.png" alt="my alt text"/>
...
<div class="video_container">
    <figure>
        <video width="100%" height="auto" controls loop>
            <source src="../images/flake_trans_ior/vid.mp4" type="video/mp4">
        </video>
        <figcaption text-align="center">Film IOR from 1.0 to 3.0</figcaption>
    </figure>
    <figure>
        <video width="100%" height="auto" controls loop>
            <source src="../images/flake_trans_thickness/vid.mp4" type="video/mp4">
        </video>
...
<figure>
  <img src="../images/flake_trans_film_var/strip.png" alt="my alt text"/>
